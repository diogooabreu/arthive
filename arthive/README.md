...
Este projeto tem como objetivo implementar progressivamente e de forma didática uma aplicação web inspirada em apps de criação de portfólio, como Artstation.

O frontend da aplicação foi desenvolvido com Angular e TailwindCss e o backend foi simulado pela implementação de uma API Fake, usando o JSON Server.

## Endereço de Deploy - GitHub Pages

https://github.com/diogooabreu/arthive.git

## Protótipo

https://www.figma.com/design/XFa8Uy3pRNjuFRonZeRCGd/DoodlesCrafts?node-id=0-1&t=1NilvCn0KGRu8uWS-1
